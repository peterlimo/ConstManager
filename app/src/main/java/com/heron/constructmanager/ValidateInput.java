...
public class ValidateInput {
    ...
    public boolean validateNachoTextView(){
        ...
        if (values == null || values.size() == 0) {
            Toast.makeText(context, "Fill in the TextView.", Toast.LENGTH_LONG).show();
            return false;
        } else {
            return true;
        }
    ...
    public boolean validateSpinner(){
        ...
        if (obj == null) {
            Toast.makeText(context, "Fill in the dropdown.", Toast.LENGTH_LONG).show();
            return false;
        } else {
            return true;
        }
    ...
    public boolean validateDeadline() {
        ...
        if (deadlinelineStr.isEmpty()) {
            Toast.makeText(context, "Fill the Deadline.", Toast.LENGTH_LONG).show();
            return false;
        } else {
            return true;
        }
    ...
    public boolean validateValue() {
        try {
            ...
            Toast.makeText(context, "The value should be composed only of numbers.", Toast.LENGTH_LONG).show();
            return false;
        }
        if (valueEditText.getText().toString().trim().isEmpty()) {
            Toast.makeText(context, "Fill in the amount.", Toast.LENGTH_LONG).show();
            return false;
        }
        return true;
    }
    ...
    public boolean validateDesc() {
        ...
        if (descStr.isEmpty()) {
            Toast.makeText(context, "Fill in the description.", Toast.LENGTH_LONG).show();
            return false;
        } else {
            return true;
        }
    ...
    public boolean validateTitle() {
        ...
        if (titleStr.isEmpty()) {
            Toast.makeText(context, "Fill out the Title.", Toast.LENGTH_LONG).show();
            return false;
        } else {
            return true;
        }
    ...
    public boolean validateReason() {
        ...
        if (reasonStr.isEmpty()) {
            Toast.makeText(context, "Fill in the Reason.", Toast.LENGTH_LONG).show();
            return false;
        } else {
            return true;
        }
    ...
    public boolean validateAddress() {
        ...
        if (addressStr.isEmpty()) {
            Toast.makeText(context, "Fill in the address.", Toast.LENGTH_LONG).show();
            return false;
        } else {
            return true;
        }
    ...
    public boolean validateType() {
        ...
        if (typeStr.isEmpty()) {
            Toast.makeText(context, "Fill in the type of building or construction.", Toast.LENGTH_LONG).show();
            return false;
        } else {
            return true;
        }
    ...
    public boolean validateResponsibles() {
        ...
        if (responsiblesStr.isEmpty()) {
            Toast.makeText(context, "who is responsible for the construction", Toast.LENGTH_LONG).show();
            return false;
        } else {
            return true;
        }
    ...
    public boolean validateEmail() {
        ...
        if (emailStr.isEmpty()) {
            Toast.makeText(context, "Fill in your email.", Toast.LENGTH_LONG).show();
            return false;
        } else if (!Patterns.EMAIL_ADDRESS.matcher(emailStr).matches()) {
            Toast.makeText(context, "E-mail invalid", Toast.LENGTH_LONG).show();
            return false;
        } else {
            return true;
        }
    ...
    public boolean validatePassword() {
        ...
        if (pwStr.isEmpty()) {
            Toast.makeText(context, "Fill in your password", Toast.LENGTH_LONG).show();
            return false;
        } else if (pwStr.length() < 8) {
            Toast.makeText(context, "Fill in a password that is longer than 8 characters.", Toast.LENGTH_LONG).show();
            return false;
        } else {
            return true;
        }
    ...
    public boolean validateRepeatPassword() {
        ...
        if (repeatPwStr.isEmpty()) {
            Toast.makeText(context, "Fill in your password again", Toast.LENGTH_LONG).show();
            return false;
        }
        else if (!repeatPwStr.equals(pwStr)) {
            Toast.makeText(context, "The filled passwords are different", Toast.LENGTH_LONG).show();
            return false;
        }
        return true;
    }
