            ...
            public void onClick(View v) {
                ...
                if (user != null) {
                    if (newPasswordStr.equals(repeatPasswordStr)) {
                        ...
                        Toast.makeText(UpdatePasswordFormActivity.this, "password successfully updated", Toast.LENGTH_LONG).show();

                    } else {
                        Toast.makeText(UpdatePasswordFormActivity.this, "Passwords do not match.", Toast.LENGTH_LONG).show();
                    }
                }
            }
        });
